...
def generate_review_html(input_md_path: str):
    ...
    overview_prompt = '''以下是我刚完成的英语翻译练习，内容包含：
                                ...
                                3. 针对每一段翻译的问题，把值得我记忆和模仿使用的重点（包括但不限于：短语、句式）提取出来、并且每个重点配一个中文句子翻译练习，用到这个知识点；所有这些重点配新句子翻译练习，一起放在最后的【重点造句练习】部分；
                                4. 如果你可以的话，请把这些内容整理成一个【布局格式好看】【内容直观】的markdown复习手册，我方便导出或复习。

                                这是一个结果文档的模板：【
                                # Translate quiz review
...
| 知识点                           | 示例句子                                                      | 中文翻译练习              |
| ----------------------------- | --------------------------------------------------------- | ------------------- |
| 🔹 倒装句：Next to us lives...    | **Next to us lives** an old couple who own a bakery.      | 我们家隔壁住着一对经营面包店的老夫妻。 |
| 🔹 in one’s early sixties     | He is **in his early sixties**, but still full of energy. | 他六十岁出头，但仍然充满活力。     |
| 🔹 easy to get along with     | She is **easy to get along with**, everyone likes her.    | 她很容易相处，大家都喜欢她。      |
